# Update the main README.md with Marco's information and remove AI-like content
readme_content = '''# ICS Security Sentinel 🛡️
...
git clone https://github.com/marcolucchese/ics-security-sentinel.git
cd ics-security-sentinel
...
- [Sigma Rules Guide](docs/sigma_rules_guide.md)
...
Cybersecurity Specialist with expertise in Industrial Control Systems and Operational Technology security.
...
print("✅ Updated README.md with Marco's information")